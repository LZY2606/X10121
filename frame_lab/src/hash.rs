// SHA-256 (FIPS 180-4), implemented with std only. Used for content-addressing
// protocol versions and blobs.
...
/// Collision-resistant identifier derived from content plus a creation marker.
pub fn content_id(kind: &str, canonical: &str) -> String {
    ...
    format!("{}_{}", kind, &hex_encode(&digest[..12]))
}
